import { Lightbulb, Rocket, RocketIcon, Sparkles, Target } from "lucide-react";

export default function TrustSection() {
  return (
    <section className="py-20 lg:py-32 bg-white dark:bg-slate-950 px-4 md:px-0">
        ...
        <div className="bg-linear-to-br from-emerald-600 via-emerald-700 to-teal-800 rounded-[2.5rem] p-8 md:p-16 lg:p-20 relative overflow-hidden shadow-2xl shadow-emerald-900/20">
          ...
          <div className="relative z-10">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              <div>
                <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md text-white px-6 py-2 rounded-full text-sm font-bold mb-8 border border-white/20 shadow-lg">
                  We&apos;re expanding day by day <RocketIcon size={20} />
                </div>
