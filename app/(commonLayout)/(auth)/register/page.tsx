          ...
          <div className="pt-8 space-y-4">
            <div className="flex items-center gap-4">
              <div className="flex -space-x-2">
                <div className="h-10 w-10 rounded-full bg-linear-to-br from-pink-400 to-purple-600 border-2 border-white" />
                <div className="h-10 w-10 rounded-full bg-linear-to-br from-blue-400 to-cyan-600 border-2 border-white" />
