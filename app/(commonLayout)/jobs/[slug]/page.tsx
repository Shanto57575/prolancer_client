        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
            ...
            <div className="rounded-2xl bg-white dark:bg-slate-950 shadow dark:shadow-emerald-500 border p-6 sm:p-8">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
                ...
                <div className="text-center p-3 rounded-lg bg-green-500/5 border border-green-500/10">
                  ...
                  <p className="text-xs  mt-1">Positions</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow border p-6 sm:p-8">
              ...
              <div className="flex flex-wrap gap-2">
                {job.requiredSkills?.map((skill: string) => (
                  <Badge
                    key={skill}
                    className="px-3 py-1.5 text-sm font-medium bg-slate-950 text-white hover:bg-gray-800"
                  >
                    {skill}
                  </Badge>
                ))}
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-6 space-y-6">
              ...
              <div className="rounded-2xl p-6 shadow-md border-t border-slate-200">
